...
map["BASE_DATA_PATH"]="/home/deepikajain/.rdata/files1/";
...
if(typeof qbucketArr[qname] == 'undefined'){
	console.log("base table name"+map["BASE_TABLE"]);
  return map["BASE_TABLE"];
}else{
...
exports.abc=function getTableNameA(){
console.log("base table in config"+map["BASE_TABLE"]);
//console.log("abcd"+cbqtm.getBaseTable);
}


exports.setProdTab=function setProdTab(prodTab){
console.log("set function called");
	map["BASE_TABLE"]=prodTab;
